...
export default function Home() {
  ...
  return (
    <div className=' relative w-screen min-h-screen overflow-hidden nunito sc-1'>
      ...
      {pos !== 5 && (
        <button
          className={`absolute bottom-[3.2rem] text-[1.1rem]  right-4 lg:right-[30vw] lg:bottom-[2vw] z-50 text-sm px-3 py-2 rounded-[5px] bg-[#ff715b] font-bold text-[#FFFFFF] ${
      ...
      {condition && (
        <button
          className='absolute bottom-[3.2rem] left-4 lg:left-[30vw] lg:bottom-[2vw] z-50'
          onClick={handlePrev}
        >
